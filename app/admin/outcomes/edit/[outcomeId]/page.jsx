...
export default function EditOutcome() {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      updateOutcome(outcomeId, formData)
      router.push("/admin/outcomes")
    }
  }
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-gray-900">Edit Learning Outcome</h1>
            <p className="mt-1 text-sm text-gray-500">Update the details of this learning outcome.</p>
          </div>
        </div>
      </div>
